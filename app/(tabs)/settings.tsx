    ...
    return (
        <View className="flex-1 bg-slate-50 dark:bg-slate-900">
            ...
            <View
                ...
                <Text className="text-slate-900 dark:text-slate-100 font-bold text-2xl">Settings</Text>
            </View>
            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                    ...
                    <View className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 shadow-sm">
                        <View className="flex-row items-center">
                            ...
                            <View className="flex-1">
                                <Text className="text-slate-900 dark:text-slate-100 font-bold text-xl mb-1">
                                    {user?.name}
                                </Text>
                                <Text className="text-slate-700 dark:text-slate-100 text-sm">
                                    {user?.email}
                                </Text>
                            </View>
                        </View>
                ...
                <View className="px-6 pb-4">
                    <Text className="text-slate-900 dark:text-slate-100 font-bold text-lg mb-3">Security</Text>

                    {/* Password Storage Toggle */}
                    <View
                        className="bg-white dark:bg-slate-800 rounded-2xl mb-3 shadow-sm border border-slate-200 dark:border-slate-700">
                    ...
                    {passwordFeatureEnabled && (
                        <TouchableOpacity
                            ...
                            className="bg-white dark:bg-slate-800 rounded-2xl px-4 py-4 flex-row items-center shadow-sm border border-slate-200 dark:border-slate-700"
                        >
                ...
                <View className="px-6 pb-4">
                    ...
                    <View
                        ...
                        >
                            ...
                            <View className="flex-1">
                                <Text className="text-slate-900 dark:text-slate-100 font-semibold">About
                                    WhichEmail</Text>
                                <Text className="text-slate-500 dark:text-slate-400 text-xs mt-0.5">
                        ...
                        <View className="px-4 py-4 flex-row items-center">
                            ...
                            <View className="flex-1">
                                <Text className="text-slate-900 dark:text-slate-100 font-semibold">Version</Text>
                                <Text className="text-slate-500 dark:text-slate-400 text-xs mt-0.5">1.0.0</Text>
                            </View>
                        </View>
                    </View>
                </View>
                ...
                <View className="px-6 pb-8">
                    <Text className="text-slate-900 dark:text-slate-100 font-bold text-lg mb-3">Account</Text>
                    ...
                    >
                        ...
                        <View className="flex-1">
                            <Text className="text-red-600 dark:text-red-500 font-semibold">Sign Out</Text>
                        </View>
                ...
                <View className="px-6 pb-12 mt-10">
                    <View
                        className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-800 dark:to-slate-800 rounded-2xl p-6 border border-blue-100 dark:border-slate-700">
                        <View className="flex-row items-center mb-2">
                            <Ionicons name="heart" size={16} color="#ef4444"/>
                            <Text className="text-slate-700 dark:text-slate-300 text-sm ml-2">Made with love by</Text>
                        </View>

                        <Text className="text-slate-900 dark:text-slate-100 font-bold text-lg">Fanyi Charllson</Text>
